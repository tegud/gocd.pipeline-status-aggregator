...
function storePipelineStatus(pipelineEvent, apiResponse) {
	return new Promise(function (resolve, reject) {
		var doucmentKey = buildPipelineDocumentKey;
		var releaseStatus = {
...
function handleMessage(goClient, pipelineEvent) {
	...
	var storePipelineAndStageStatus = Promise.all([
		storePipelineStatus.bind(undefined, pipelineEvent),
		storeStageStatus.bind(undefined, pipelineEvent)
	]);
