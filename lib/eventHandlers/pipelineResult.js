...
module.exports = function() {
	...
	function storeMaterialLinks(teams, pipelineEvent, apiResponse) {
		return new Promise(function (resolve, reject) {
			resolve();
		});
	}
