...
module.exports = function storeMaterialLink(teams, pipelineEvent, apiResponse) {
    return new Promise(function (resolve, reject) {
        ...
        function materialId(baseInformation, cause) {
            logger.logInfo('Buildng material document id', { baseFullPath: baseInformation.fullPath, gitUrl: cause.material['git-configuration'].url, revision: cause.modifications[0].revision });
