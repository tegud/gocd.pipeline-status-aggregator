    ...
    return new Promise(function (resolve, reject) {
        ...
        function material(baseInformation, cause) {
            return _.merge({
                ...
                revision: cause.modifications.revision
        ...
        function materialId(baseInformation, cause) {
            ...
            id += cause.modifications.revision;
        ...
        function materialLag(baseInformation, cause) {
            if(calculatePipelineLag && material.changed) {
                return {
                    commitToTriggerInMs: moment(baseInformation['@timestamp']).diff(moment(cause.modifications['modified-time']), 'ms')
                };
            }
        }
