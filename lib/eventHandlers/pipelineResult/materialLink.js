...
module.exports = function storeMaterialLink(teams, pipelineEvent, apiResponse) {
    return new Promise(function (resolve, reject) {
        ...
        function materialId(baseInformation, cause) {
            ...
            var sanitizedId = id.replace(/[^a-z]/g, "");

            logger.logInfo('Buildng material document id', {
                baseFullPath: baseInformation.fullPath,
                gitUrl: cause.material['git-configuration'].url,
                revision: cause.modifications[0].revision,
                fullId: id,
